...
public class PetBoundary implements Tela {
    ...
    private ObservableList<String> tipos = 
        FXCollections.observableArrayList("Gato", "Cachorro", "Papagaio");
    ...
    public Pane render() { 
        ...
        Bindings.bindBidirectional( dtaNascimento.valueProperty(), control.nascimento);
